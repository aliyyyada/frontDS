...
export function IconPhone({ size = 13 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={BLUE} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
...
export function IconEdit({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={BLUE} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
...
export function IconDocs({ size = 18 }) {
  return (
...
export function IconPencilDark({ size = 16 }) {
  return (
...
export function AvatarPlaceholder() {
  return (
    <svg viewBox="0 0 24 24" fill="#8A8A8A">
